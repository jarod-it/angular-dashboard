...
@Component({
  selector: 'app-unifocaux',
  standalone: true,
  imports: [],
  templateUrl: './unifocaux.component.html',
  styleUrl: './unifocaux.component.scss'
})
export class UnifocauxSubComponent {
  totalPrice: number = 0;
  ...
  ngOnInit() {
    ...
    let priceContainer: HTMLSpanElement = this.elementRef.nativeElement.querySelector('#price-container-paire2-unifocaux')
